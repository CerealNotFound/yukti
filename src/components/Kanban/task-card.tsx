...
import { type KanbanTask, updateTaskDetails, deleteTask } from "@/utils/kanban-actions/actions"
      ...
      setColumns(
        columns.map((column) => ({
          ...
          tasks: column.tasks.map((t) =>
            t.id === task.id ? { ...t, title, description: description || null, dueDate: dueDate || null } : t,
          ),
        })),
      )
      setIsEditing(false)
